# Generated by Django 4.2.2 on 2023-06-24 22:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(max_length=200)),
                ('carry_limit', models.PositiveIntegerField(default=10)),
                ('traits', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='traits', to='game.player')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('characterinstance_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='game.characterinstance')),
                ('traits', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='game.npcprefab')),
            ],
            bases=('game.characterinstance',),
        ),
        migrations.CreateModel(
